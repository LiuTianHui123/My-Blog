...
<template>
  ...
  <div
    ...
    class="footBack footBackQian"
  >
    <div class="footer-img"></div>
    <div class="fcontainer">
      <p>
        博客已萌萌哒运行<span v-html="longTime">{{ longTime }}</span
        ><span class="timeJump">(●'◡'●)ﾉ♥</span>
      </p>
      <p>
        托管于
        <a href="https://github.com/LiuTianHui123/My-Blog" target="_blank"
          >GitHub</a
        >.
      ...
      <p>
        博客由
        <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 搭建. Theme By
        <a href="https://diygod.me/" target="_blank">diygod.me</a>
      </p>
      <p>
        <span>Made with</span>
        <img class="fheart" src="static/img/heart02.png" />
        <span>by Henery.</span>
      </p>
    </div>
  </div>
  ...
  <div v-else class="footBack footBackHui">
    <div class="footer-img">
      <img
        :src="
          this.$store.state.themeObj.bottom_img
            ? this.$store.state.themeObj.bottom_img
            : 'static/img/footer01.png'
        "
        alt=""
      />
    </div>
    <div class="fcontainer">
      ...
      <p>
        托管于 <a href="https://gitee.com/qinlh/" target="_blank">GitHub</a>.
        <a
...
export default {
  ...
  methods: {
    ...
    runTime: function () {
      //运行倒计时
      var that = this;
      var oldTime = new Date("2021/09/15 00:00:00");
