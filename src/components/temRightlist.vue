        ...
        <img
          :src="
            this.$store.state.themeObj.center_smailimg
              ? this.$store.state.themeObj.center_smailimg
              : 'static/img/headtou02.jpg'
          "
          alt=""
        />
        <h1 v-if="this.$store.state.themeObj.user_start != 0">Henery</h1>
      </div>
      <div class="r1-body">
        <p>你能抓到我么？</p>
        <div class="catch-me">
    ...
    return {
      ...
      catchMeObj: {
        ...
        Henery: {
          ...
          csdn: "https://blog.csdn.net/weixin_50529544",
          job: "",
        },
      },
      isHenery: this.$store.state.themeObj.user_start != 0 ? "Henery" : "Qinlh", //判断是哪个的博客
    };
  },
  methods: {
    //事件处理器
